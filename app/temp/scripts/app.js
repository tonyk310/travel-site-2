...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lazysizes__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lazysizes___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lazysizes__);
...
var moblieMenu = new __WEBPACK_IMPORTED_MODULE_1__modules_MobileMenu_js__["a" /* default */]();

var revealFeaturesOnScroll = new __WEBPACK_IMPORTED_MODULE_2__modules_RevealOnScroll_js__["a" /* default */](__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.feature-item'), '85%');
...
// METHODS ///////////////////////////
	...
	createHeaderWaypoint() {
		...
		new Waypoint({
			...
			handler: function(direction) {
				if(direction === 'down'){
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.site-header').addClass('site-header--dark');
				} else {
					__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.site-header').removeClass('site-header--dark');
				}
			}
		});
	}
	...
	createPageSectionWaypoints() {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.page-section').each(function(){
			...
			new Waypoint({
				...
				handler: function(direction) {
					...
					if(direction === 'down'){
						...
						__WEBPACK_IMPORTED_MODULE_0_jquery___default()('.primary-nav a').removeClass('is-current-link');
